...
//    static private let PunctuationCharacters = [",", "?", ".", "，", "？", "。"]
//    static private let SentenceBoundaryCharacters = ["?", ".", "？", "。"]
//    
...
//    }
//    
//    static func createStringWithText(_ textstream: SttText,finalClourse:((String,String)->Void)?) -> (String,String,String,Int,String) {
...
//        
//        for item in words {
//            guard let word: SttWord = item as? SttWord else { return defaultReturnValue }
//            if word.isFinal {
...
//        return PunctuationCharacters.contains(word)
//    }
//    
//    static func isSentenceBoundaryWord(_ word:String) -> Bool {
//        return SentenceBoundaryCharacters.contains(word)
//    }
//    
